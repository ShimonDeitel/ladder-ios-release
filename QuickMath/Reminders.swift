...
enum Reminders {
    private static let identifier = "ladder.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Time to log today's ladder save!"
        content.body = "Set aside your daily amount and keep your streak going."
